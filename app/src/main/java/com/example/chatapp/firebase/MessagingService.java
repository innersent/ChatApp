...
//        Log.d("FCM", "Token: " + token);
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        int notiifcationId = new Random().nextInt();
        ...
        builder.setSmallIcon(R.drawable.baseline_notification);
        ...
        notificationManagerCompat.notify(notiifcationId, builder.build());
    }
}
